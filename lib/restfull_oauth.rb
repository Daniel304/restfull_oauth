...
module RestfullOauth
  # This Gem will enable you to communicate to any restfull service using Oauth v1
  #
  # If you only have a consumer_token and consumer_secret then you might need to get a verifier code
  # Use this command to get your app authenticated:
  # % authenticate
  #
  # Example:
#
